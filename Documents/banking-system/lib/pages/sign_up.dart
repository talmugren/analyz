      ...
      body: ListView(
        children: [
          Column(
            children: [
              Image.network(
                  "https://i.pinimg.com/564x/5d/46/78/5d4678b5732f798569a27eacb40b1c00.jpg"),
              Row(
                ...
                children: [
                  ...
                  Text(
                    "  Sign up  ",
                    style: TextStyle(
                        fontSize: 30, color: Color.fromARGB(255, 98, 64, 161)),
                  ),
                  Text(
                    "ــــــــــــــــــــــــــ",
                    style: TextStyle(fontSize: 15, color: Colors.grey),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Color.fromARGB(255, 121, 99, 162)),
